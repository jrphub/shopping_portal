...
if ($_POST['submit']) {
    if ($_POST['name']
        ...
        && $_POST['phone']) {
            ...
            $userInsertValues = array('prod_id'            => "'" . $_SESSION['prod_id'] . "'",
                                      'modified_by'        => "'" . $_SESSION['userId'] . "'",
                                      'user_id'            => "'" . $_SESSION['userId'] . "'");
            $userInsertQuery = $sqlObject->createInsertQuery('xyz_orders', $userInsertValues);
            $_SESSION['order_id'] = $sqlObject->executeQuery($userInsertQuery, 5);
            header("Location:order_step_three.php");
            die();
    } else {
        $error = "Please fill up the form";
    }
}
$title = 'Step-2: Order page';
...
<style type="text/css">
    ...
    <body>
        <div align="center" id="container" style="padding-top: 10px;">
            <div style="font-size: 20px; color:#42210B;">Order Summary</div>
            <table>
                <tr>
                    <td><b>Item Name:</b></td>
            ...
            <br>
            <div style="font-size: 20px;color:#42210B;">Shipping Address</div>
